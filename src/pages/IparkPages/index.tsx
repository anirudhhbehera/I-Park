...
<div className="h-full w-full overflow-auto bg-white">
  ...
  <header className="flex items-center justify-between border-b border-gray-200 px-8 py-4">
    <div className="flex items-center gap-12">
      <div className="font-serif text-xl font-bold">
        <span className="mr-1 inline-block">I</span>
  ...
  <main className="px-8 py-6">
    ...
    <div className="mb-8 grid grid-cols-4 gap-4">
      {['Total Hotels', 'Total Customers', 'Current Users', 'New Users'].map(
        (label, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex items-end gap-2">
                ...
                <span className={`pb-1 text-sm ${textColor}`}>+15.03%</span>
              </div>
            </div>
          );
        }
    ...
    <div className="mb-8 rounded-lg bg-[#f9f9fa] p-6">
      <div className="mb-6 flex items-center justify-between">
    ...
    <div className="grid grid-cols-2 gap-6">
      {/* Contact Information */}
      <div className="rounded-lg bg-[#f9f9fa] p-6">
      ...
      {/* Traffic by Location */}
      <div className="rounded-lg bg-[#f9f9fa] p-6">
        <h2 className="mb-6 text-lg font-medium">Traffic by Location</h2>
